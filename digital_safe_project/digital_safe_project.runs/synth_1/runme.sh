...
HD_PWD='C:/vivado_projects/digital_safe_project/digital_safe_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log push_to_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source push_to_7seg.tcl
