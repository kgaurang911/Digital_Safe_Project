...
HD_PWD='C:/vivado_projects/digital_safe_project/digital_safe_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log push_to_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source push_to_7seg.tcl -notrace
